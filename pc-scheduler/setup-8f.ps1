...
Write-Host "=== InfoDisplay 8층 PC 설정 시작 ===" -ForegroundColor Cyan
...
$TASK_HB = "InfoDisplay_Heartbeat_8F"
...
$TASK_SLEEP    = "InfoDisplay_Sleep_8F"
...
# ── 완료 ─────────────────────────────────────────────────────
Write-Host ""
Write-Host "=== 8층 설정 완료 ===" -ForegroundColor Green
...
Write-Host ""
Write-Host "시작 시간 변경: Task Scheduler → InfoDisplay_Wake_8F / InfoDisplay_Sleep_8F"
